...
my %texts = (
	1 => {
		...
		is_doppleganger => 'You are the doppleganger! At night, you may choose one person (other than yourself) to copy their role. The change is permanent, and you can choose not to have it happen, but choose wisely.',
...
# Secret startrek mode text.
	2 => {
		...
		is_doppleganger => 'You are the changeling! During the scanning periods, you may choose one person (other than yourself) to copy their role. The change is permanent, and you can choose not to have it happen, but choose wisely.',
